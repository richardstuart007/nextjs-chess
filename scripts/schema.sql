...
CREATE TABLE IF NOT EXISTS tplr_player_ratings (
  plr_plrid      INTEGER GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
...
CREATE TABLE IF NOT EXISTS tsa_savedanalyses (
  sa_said          INTEGER GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
  sa_grid          INTEGER,
...
CREATE TABLE IF NOT EXISTS tec_ecoreference (
  ec_ecid          INTEGER GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
...
CREATE TABLE IF NOT EXISTS tgev_game_evals (
  gev_gevid          INTEGER GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
